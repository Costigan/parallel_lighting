...
namespace viper.corelib.spice
{
    public class CSpice
    {
        ...
        [DllImport("cspice.so", CallingConvention = CallingConvention.Cdecl)]
        ...
        // The 5D accounts for leap seconds since 2000.  This is valid only for dates after 12/31/2016.
        // 12/31/2005	23:59:60	33 secs
        // 12/31/2008	23:59:60	34 secs
        ...
        public static Vector3d SunPosition(DateTime time)
        {
            ...
            double lt = 0d;
            spkgeo_c(SunId, et, "MOON_ME", MoonId, state, ref lt);
        ...
        public unsafe static Vector3d EarthPosition(DateTime time)
        {
            ...
            var state = new double[6];
            double lt = 0d;
            spkgeo_c(EarthId, et, "MOON_ME", MoonId, state, ref lt);
            return new Vector3d(state[0], state[1], state[2]);
        }
